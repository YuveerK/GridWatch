...
- An active or unplanned outage and a planned-maintenance schedule in the same graphic are separate faults. The active outage is one fault. Each planned job is its own fault with status PLANNED. Do not put the planned substations or their suburbs on the active outage.
