...
DO $$ BEGIN
  CREATE TYPE "SourcePostProcessingStatus" AS ENUM ('UNPROCESSED', 'PROCESSING', 'RELEVANT', 'IRRELEVANT', 'PROCESSING_ERROR', 'NEEDS_REVIEW');
EXCEPTION WHEN duplicate_object THEN NULL;
END $$;

CREATE TABLE IF NOT EXISTS "SourcePost" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "SourcePost_platform_externalId_key" UNIQUE ("platform", "externalId")
);
...
-- AlterEnum
DO $ BEGIN
  ALTER TYPE "SourcePostProcessingStatus" ADD VALUE 'NEEDS_REVIEW';
EXCEPTION WHEN duplicate_object THEN NULL;
END $;

-- DropIndex
DROP INDEX IF EXISTS "SourcePost_processingStatus_idx";

-- DropIndex
DROP INDEX IF EXISTS "SourcePost_processingStatus_processingStartedAt_idx";

-- DropIndex
DROP INDEX IF EXISTS "SourcePost_publishedAt_idx";

-- DropIndex
DROP INDEX IF EXISTS "SourcePost_sourceAccount_publishedAt_idx";

-- DropEnum
DROP TYPE IF EXISTS "AreaIncidentAssociationStatus";

-- DropEnum
DROP TYPE IF EXISTS "AreaIncidentBasis";

-- DropEnum
DROP TYPE IF EXISTS "AreaIncidentConfidenceBand";

-- DropEnum
DROP TYPE IF EXISTS "AreaIncidentEvidenceStatus";

-- DropEnum
DROP TYPE IF EXISTS "AreaIncidentEvidenceType";

-- DropEnum
DROP TYPE IF EXISTS "AreaIntelligenceProcessingStatus";

-- DropEnum
DROP TYPE IF EXISTS "AreaIntelligenceTrigger";

-- DropEnum
DROP TYPE IF EXISTS "AutomationRunStatus";

-- DropEnum
DROP TYPE IF EXISTS "AutomationRunTrigger";

-- DropEnum
DROP TYPE IF EXISTS "CombinedCompleteness";

-- DropEnum
DROP TYPE IF EXISTS "ImageAttemptStatus";

-- DropEnum
DROP TYPE IF EXISTS "ImageProcessingStatus";

-- DropEnum
DROP TYPE IF EXISTS "ImageProcessingTrigger";

-- DropEnum
DROP TYPE IF EXISTS "IncidentAssociationStatus";

-- DropEnum
DROP TYPE IF EXISTS "IncidentLifecycleStatus";

-- DropEnum
DROP TYPE IF EXISTS "IncidentMatchDecision";

-- DropEnum
DROP TYPE IF EXISTS "IncidentProcessingRunStatus";

-- DropEnum
DROP TYPE IF EXISTS "IncidentTimelineEventType";

-- DropEnum
DROP TYPE IF EXISTS "IncidentType";

-- DropEnum
DROP TYPE IF EXISTS "MatchConfidenceBand";

-- DropEnum
DROP TYPE IF EXISTS "MediaFetchStatus";

-- DropEnum
DROP TYPE IF EXISTS "MediaFetchTrigger";

-- DropEnum
DROP TYPE IF EXISTS "NoticeClassification";

-- DropEnum
DROP TYPE IF EXISTS "ObservationEventType";

-- DropEnum
DROP TYPE IF EXISTS "ObservationOperationalStatus";

-- DropEnum
DROP TYPE IF EXISTS "ObservationProcessingRunStatus";

-- DropEnum
DROP TYPE IF EXISTS "ReconciliationRunStatus";

-- DropEnum
DROP TYPE IF EXISTS "ResponsibleUtility";

-- DropEnum
DROP TYPE IF EXISTS "TopologyAliasEvidenceType";

-- DropEnum
DROP TYPE IF EXISTS "TopologyAliasStatus";

-- DropEnum
DROP TYPE IF EXISTS "TopologyConfidenceBand";

-- DropEnum
DROP TYPE IF EXISTS "TopologyConflictStatus";

-- DropEnum
DROP TYPE IF EXISTS "TopologyConflictType";

-- DropEnum
DROP TYPE IF EXISTS "TopologyEdgeStatus";

-- DropEnum
DROP TYPE IF EXISTS "TopologyEvidenceStatus";

-- DropEnum
DROP TYPE IF EXISTS "TopologyEvidenceStrength";

-- DropEnum
DROP TYPE IF EXISTS "TopologyNodeOrigin";

-- DropEnum
DROP TYPE IF EXISTS "TopologyNodeStatus";

-- DropEnum
DROP TYPE IF EXISTS "TopologyNodeType";

-- DropEnum
DROP TYPE IF EXISTS "TopologyProcessingStatus";

-- DropEnum
DROP TYPE IF EXISTS "TopologyProcessingTrigger";

-- DropEnum
DROP TYPE IF EXISTS "TopologyRelationType";

-- DropEnum
DROP TYPE IF EXISTS "XSyncRunStatus";
